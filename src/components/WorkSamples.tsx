      ...
      <div className="mx-auto px-4 max-w-6xl relative z-10">
        <div className="text-center mb-16 space-y-4">
          <h2 className="text-3xl md:text-5xl font-black tracking-tight">
            {t("samples.title_part1")}
            <span className="text-primary ms-4">
              {t("samples.title_part2")}
            </span>
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {samples.map((sample, index) => (
            ...
            >
              <Card className="overflow-hidden pt-0 group border-none shadow-xl shadow-primary/5 hover:shadow-2xl transition-all duration-300 h-full">
